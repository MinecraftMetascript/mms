...
func minecraftmetascriptlexerLexerInit() {
	...
	staticData.serializedATN = []int32{
		...
		61, 1, 0, 0, 0, 19, 63, 1, 0, 0, 0, 21, 66, 1, 0, 0, 0, 23, 69, 1, 0, 0,
		...
		5, 46, 0, 0, 60, 16, 1, 0, 0, 0, 61, 62, 5, 33, 0, 0, 62, 18, 1, 0, 0,
		0, 63, 64, 5, 38, 0, 0, 64, 65, 5, 38, 0, 0, 65, 20, 1, 0, 0, 0, 66, 67,
		5, 124, 0, 0, 67, 68, 5, 124, 0, 0, 68, 22, 1, 0, 0, 0, 69, 70, 5, 73,
